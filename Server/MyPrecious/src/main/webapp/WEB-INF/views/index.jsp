...
function changeSourceView(obj){
   ...
   var a_name = $('#a_name').val();
     ...
     var adminData = {'a_name':a_name,'a_pw':encodeStr};
     //    console.log
	 alert(JSON.stringify(adminData));
     
     $.ajax({
         url : 'wv/admins/loginCheck',                        
         method : "post", 
         dataType : 'json',
        ...
        <div class="modal-body" style="padding:40px 50px;">
          ...
          <form name="mainForm" action="abcd">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="a_name" placeholder="Enter name">
            </div>
            <div class="form-group">
              <label for="psw"><span class="glyphicon glyphicon-eye-open"></span> Password</label>
              <input type="text" class="form-control" id="a_pw" placeholder="Enter password">
            </div>
<!-- type="submit" -->
              <button onclick="changeSourceView(a_pw)" class="btn btn-success btn-block"><span class="glyphicon glyphicon-off"></span> Login</button>
          </form>
        </div>
